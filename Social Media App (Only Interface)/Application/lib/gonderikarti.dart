...
class GonderiKarti extends StatelessWidget {
  ...
  const GonderiKarti({required this.profilResimLinki,required this.isimSoyad,required this.gecenSure,required this.gonderiResimLinki,required this.aciklama});
